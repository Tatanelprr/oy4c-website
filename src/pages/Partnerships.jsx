      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSub}>
            OY4C partners with organisations that share our commitment to youth empowerment, climate education, and systemic change. Together, we go further.
          </p>
        </div>
      </section>
      ...
      <section className={styles.intro}>
        <div className={styles.introInner}>
          <div className={styles.introText}>
            ...
            <p>
              Partnerships are at the heart of how OY4C scales its mission. We believe that closing the global climate education gap requires collective action — and that means building bridges between youth organisations, schools, NGOs, and businesses that share our values.
            </p>
            <p>
          ...
          <div className={styles.introValues}>
            {[
              { icon: <Globe size={20} />, text: 'Global reach across 40+ countries' },
              { icon: <Users size={20} />, text: '500+ passionate youth volunteers' },
